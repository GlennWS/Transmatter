...
//{
//	if(moved_up == 1) and place_free(x,y + collision_speed + 2)
//	{
//		temp_pos_y -= player_speed;
...
//	if(moved_left == 1) and place_free(x - collision_speed,y)
//	{
//		temp_pos_x -= player_speed;
...
//	if(moved_down == 1) and place_free(x,y - collision_speed - 2)
//	{
//		temp_pos_y += player_speed;
...
//	if(moved_right == 1) and place_free(x + collision_speed,y)
//	{
//		temp_pos_x += player_speed;
...
//			with(instance_create_layer(xplace,yplace,"Instances_1",global.obj_array_attacking[player_direction]))
//			{
